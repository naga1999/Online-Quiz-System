...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>> <a href="images.html"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;Low Fidelity</a></li>
	    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>> <a href="LOGIN PAGE.xd"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>&nbsp;High Fidelity</a></li>
	    <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>> <a href="video.mp4"><span class="glyphicon glyphicon-play" aria-hidden="true"></span>&nbsp;Concept video</a></li>
        </ul>
